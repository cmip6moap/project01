...
# np.savez('cleaned_historical.npz',t=t, steric=steric, modelnames=modelnames) # this format is convenient to load in python
...
# np.savetxt('cleaned_historical.txt', d, header=' '.join(headers) )
